...
namespace WindowsFormsApp2
{
    ...
    {
        string[] nameOil = { "Бензин-92", "Бензин-95", "Бензин-95-премиум", "Дизтопливо", "Газ" };
        ...
        {
            picBoxSmile.Image = Image.FromFile("1.jpg");
            picBoxSmile.SizeMode = PictureBoxSizeMode.Zoom;
        }
        ...
        private void grBoxPaymentPet_Enter(object sender, EventArgs e)
        {
            ...
            comboBoxPetrol.SelectedIndex = 0;//выбор определенного вида горючего
            txtBoxPrice.Text = $" {oil[0]}";//цена на данный вид продукта
            ...
            txtBoxQuantity.TextChanged += Radio_TextChanged;//изминения в полях покупка топлива и подсчет суммы
            txtBoxSum.TextChanged += Radio_TextChanged;

            //CheckBox-сов и изменение значений полей ReadOnly
            ...
            //изменения значений в полях покупки товаров в кафе и подсчет суммы
            ...
            //проверка на изменения значения вывода основной суммы кафе
        ...
        private void butToCount_Click(object sender, EventArgs e)
        {
            if (PayGasSt + PayCafe != 0)
            {
                ...
                DialogResult result = MessageBox.Show("Очистить все поля?", "Внимание", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                ...
                {
                    Thread.Sleep(3000);
                    MessageBox.Show("Продолжить? Нажмите посчитать снова!", "Внимание", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                }
            }
            else
            {
        ...
        private void comboBoxPetrol_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(selectedPetrol); 
        }
